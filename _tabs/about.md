...
> **웃기지만, 우습지 않게 사는 개발자가 되고 싶어요!**

## **⚡️ 그가 온다..! 긴장하자(?)**

느슨해진 개발자 시장에 한 줄기 긴장?감을 주는 이름 — **기처리(GichuL)** <br/>
이제 막 세상에 코드를 던져 대기 시작한, 그러나 이미 몸에는 리듬감이 배어있는 사람이라고 하던데? ~~(랩 좀 한다고 하더라고..)~~ <br/>
음악인으로서 **리듬의 흐름을 이해하고**, 마라토너로서 **꾸준함의 흐름을 믿으며**, 개발자로서 **사람의 흐름을 설계하고자 한다**!
...
- **대학 중앙러닝동아리 RIKU (러닝 동아리) (2022 ~ 2026.02)**  
	> 부회장, 페이서, 러너 <br/>
...
React/Next.js, Django 등의 프론트엔드·백엔드 대표 기술들을 중심으로.. <br/>
“사용자가 ‘편하다’고 느끼는 경험”을 AI와 함께 만들어 가는 **UX 중심 개발자**가 되고자 노력중입니다. 

- 기술 스택: React / Next.js / TypeScript / Tailwind / Zustand / Redux Toolkit / Python / Django / Figma
- 관심사: UX 구조 설계, 인터랙션 디테일, 성능 최적화, AX
...
2025년에는, 프론트엔드 엔지니어로 성장을 계속했습니다..<br/>
2026년에는, 발전한 AI 기술과 함께 프론트/백엔드/디자인 경계를 넘어 좋은 제품을 만들기 위해 노력 중입니다..<br/>
